...
-- Trucks
INSERT INTO trucks (id, user_id, truck_type, capacity_tons, permit_number, home_state, registration_number) VALUES
...
INSERT INTO driver_availability (id, user_id, current_lat, current_lng, dest_lat, dest_lng, current_city, destination_city, status) VALUES
...
-- Open Loads
INSERT INTO loads (id, user_id, pickup_lat, pickup_lng, delivery_lat, delivery_lng, pickup_city, delivery_city, cargo_type, weight_tons, description, offered_price, timeline, status) VALUES
...
INSERT INTO bookings (id, load_id, driver_id, shipper_id, agreed_price, status, booked_at, delivered_at) VALUES
...
-- Reset sequences so auto-increment counters don't clash with manually inserted IDs
SELECT setval('users_id_seq', (SELECT MAX(id) FROM users));
SELECT setval('trucks_id_seq', (SELECT MAX(id) FROM trucks));
SELECT setval('driver_availability_id_seq', (SELECT MAX(id) FROM driver_availability));
