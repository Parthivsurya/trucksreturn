...
class ShipperBookingsTab extends StatefulWidget {
  const ShipperBookingsTab({super.key});

  @override
  State<ShipperBookingsTab> createState() => _ShipperBookingsTabState();
}

class _ShipperBookingsTabState extends State<ShipperBookingsTab> {
  ...
  Future<void> _load() async {
    ...
    final list = await ShipperApi.getBookings();
    if (!mounted) return;
    setState(() {
      _bookings = list;
      _loading = false;
                        ...
                        const Center(
                          child: Padding(
                            ...
                            child: Column(children: [
                              ...
                              SizedBox(height: 6),
                              Text('Bookings will appear here when drivers accept your loads',
