...
class ShipperProfileTab extends StatelessWidget {
  const ShipperProfileTab({super.key});
    ...
    return SafeArea(
      child: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          _MenuItem(icon: Icons.business_center_rounded, label: 'Company details', onTap: () {}),
          _MenuItem(icon: Icons.payments_rounded, label: 'Payments', onTap: () {}),
