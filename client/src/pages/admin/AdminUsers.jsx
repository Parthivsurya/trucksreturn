    ...
    <AdminLayout>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 text-center">
            ...
            <p className="text-slate-500 text-sm mb-5">
              <strong>{confirmDelete.name}</strong> and all their data will be permanently removed.
            </p>
      ...
      <div className="p-6 lg:p-8">
        ...
        <div className="card mb-6 flex flex-col sm:flex-row gap-3">
          ...
          <button onClick={() => { setPage(1); loadUsers(); }} className="btn-primary !py-2.5 text-sm">
            Search
          </button>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-100">
                  <th className="text-left px-5 py-3 text-xs text-slate-400 uppercase tracking-wider font-semibold">User</th>
                  <th className="text-left px-5 py-3 text-xs text-slate-400 uppercase tracking-wider font-semibold">Role</th>
                  <th className="text-left px-5 py-3 text-xs text-slate-400 uppercase tracking-wider font-semibold hidden md:table-cell">Truck</th>
                  <th className="text-left px-5 py-3 text-xs text-slate-400 uppercase tracking-wider font-semibold hidden sm:table-cell">Rating</th>
              ...
              <tbody className="divide-y divide-slate-50">
                {loading ? (
                  ...
                  <tr key={u.id} className={`hover:bg-slate-50 transition-colors ${u.is_active === 0 ? 'opacity-60' : ''}`}>
